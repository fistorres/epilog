...
public class Epithelium2 {
	...
	private EpitheliumUpdateSchemeIntra2 updateSchemeIntra;
	private EpitheliumUpdateSchemeInter updateSchemeInter;
   
	public Epithelium2(int x, int y, String topologyID, String name, LogicalModel m, RollOver rollover,
		...
		this.updateSchemeIntra = new EpitheliumUpdateSchemeIntra2();
	...
	private Epithelium2(String name, EpitheliumGrid grid, EpitheliumIntegrationFunctions eif,
			EpitheliumUpdateSchemeIntra2 epc, EpitheliumPerturbations eap, EpitheliumUpdateSchemeInter usi) {
		this.name = name;
		this.grid = grid;
	...
	public Epithelium2 clone() {
		return new Epithelium2("CopyOf_" + this.name, this.grid.clone(), this.integrationFunctions.clone(),
	...
	public boolean equals(Object o) {
		Epithelium2 otherEpi = (Epithelium2) o;
...
//		}
	 ...
	 */
	public void replacePriorities(Epithelium2 oldEpi, LogicalModel oldModel, LogicalModel newModel,
